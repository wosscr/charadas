...
def main():
    ...
    uploaded_file = st.file_uploader("Sube un archivo CSV con palabras o frases", type=["csv"], disabled=st.session_state.words_uploaded if "words_uploaded" in st.session_state else False)
